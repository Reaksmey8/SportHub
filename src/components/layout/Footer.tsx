        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="inline-flex items-center gap-3 group" aria-label="Go to Home">
              ...
              <span className="text-2xl font-black tracking-tight font-sans italic transition-colors">
                <span className="text-emerald-500 dark:text-emerald-400">S</span>
                <span className="text-slate-900 dark:text-white">ports</span>
                <span className="text-red-500 dark:text-red-400">H</span>
                <span className="text-slate-900 dark:text-white">ub</span>
              </span>
            </Link>
            ...
            <div className="flex items-center gap-2.5 pt-2 flex-wrap">
              ...
              <a
                href="#"
                aria-label="Twitter"
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-700 shadow-sm transition hover:border-emerald-500 hover:text-emerald-500 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400 dark:hover:border-emerald-400 dark:hover:text-emerald-400"
              >
              ...
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-700 shadow-sm transition hover:border-emerald-500 hover:text-emerald-500 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400 dark:hover:border-emerald-400 dark:hover:text-emerald-400"
              >
                <svg className="h-4 w-4 stroke-current stroke-2 fill-none" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round">
